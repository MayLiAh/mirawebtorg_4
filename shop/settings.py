...
SECRET_KEY = 'django-insecure-#amy#wf$z=2tuk_%_rw%_0k(wlcly98f51!6$u81)ba+0vuyq-'
...
MEDIA_ROOT = os.path.join(BASE_DIR, "media")  # Медиа это папка

MEDIA_URL = "media/"

LOGIN_REDIRECT_URL = "home"  # для работы входа, после входа перекидывает на домашнюю страницу
